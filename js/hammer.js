...
//DOCUMENTS: http://hammerjs.github.io/getting-started/
! function(a, b, c, d) {
	"use strict";
	function e(a, b, c) {
	...
	function Q(a, b) {
		...
		for ( e = 0; e < g.length; )
			d[g[e].identifier] && h.push(g[e]), b & (Ca | Da) &&
			delete d[g[e].identifier], e++;
		return h.length ? [t(f.concat(h), "identifier", !0), h] :
		void 0
	}
	...
	var Oa = {
		...
		mousemove : Ba,
		mouseup : Ca
	}, Pa = "mousedown", Qa = "mousemove mouseup";
	i(L, x, {
		handler : function(a) {
			var b = Oa[a.type];
	...
	S.prototype = {
		...
		preventDefaults : function(a) {
			if (!_a) {
				...
				if (!g || !f)
					return e || f && c & Ja || g && c & Ka ? this.preventSrc(b) :
					void 0
			}
		},
	...
	U.prototype = {
		...
		dropRecognizeWith : function(a) {
			return f(a, "dropRecognizeWith", this) ? this : ( a = X(a, this),
		...
		recognize : function(a) {
			var b = ha({}, a);
			return k(this.options.enable, [this, b]) ? (this.state & (kb | lb | mb) && (this.state = gb), this.state = this.process(b),
			void (this.state & (hb | ib | jb | lb) && this.tryEmit(b))) : (this.reset(),
			void (this.state = mb))
		},
		process : function(a) {
		},
